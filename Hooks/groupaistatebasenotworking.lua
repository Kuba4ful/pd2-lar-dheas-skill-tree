...
Hooks:PreHook(GroupAIStateBase, "convert_hostage_to_criminal", "denis_converthostagetocriminal", function(self, unit, peer_unit)
	-- local player_unit = peer_unit or managers.player:player_unit()
	-- local max_minions = 1
	--local aaatest = data(self, ...)
	-- if RequiredScript == "lib/managers/group_ai_states/groupaistatebase" then
	-- log('executes properly')
	-- log('executes properly')
	-- log('executes properly')
	-- local player_unit = peer_unit or managers.player:player_unit()
	...
	--self:convert_hostage_to_criminal(...)
